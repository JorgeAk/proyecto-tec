                  ...
                  <div class="row ">
                    <div class="col-md-6">
                      <div class="">
                        ...
                        <input id="inputfirstName" type="text" class="form-control  @error('name') is-invalid @enderror" name="p_nombre"  autocomplete="name" placeholder="{{$alum->p_nombre}}"  autofocus required />
                        @error('name')
                    ...
                    <div class=" form-label-group">
                      ...
                      <input id="inputCarrera" name="carrera" type="text" class="form-control"  placeholder="{{$alum->carrera}}"  />
                    </div>
                    <div class=" form-label-group">
                      <label  for=""></label>
