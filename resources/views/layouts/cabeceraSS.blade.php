      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="{{ route('/ss') }}" class="site_title"><i class="fa fa-graduation-cap"></i> <span>IT Morelia</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/docencia/ss/perfil') }}">Perfil</a></li>
                ...
                <li><a><i class="fa fa-graduation-cap"></i>Alumnos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/docencia/ss/solicitudes') }}">Solicitudes</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-book"></i>Profesores <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{ route('/docencia/ss/profesores/revisores') }}">Revisores</a></li>
                    <li><a href="{{ route('/docencia/ss/profesores/sinodales') }}">Sinodales</a></li>
                  </ul>
                </li>
